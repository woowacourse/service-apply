...
class EvaluationTargetForm2() : BindingFormLayout<EvaluationTargetData>(EvaluationTargetData::class) {
    private val evaluationItemScores: MutableList<EvaluationItemScoreForm2> = mutableListOf()
    ...
    constructor(evaluationItems: List<EvaluationItemResponse>, evaluationItemId: Long?) : this() {
        evaluationItems.forEach {
            val answerForm = EvaluationItemScoreForm2(it.title, it.description, it.maximumScore).apply {
                setColspan(this, 2)
