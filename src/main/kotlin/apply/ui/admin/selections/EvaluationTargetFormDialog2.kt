...
class EvaluationTargetFormDialog2(
    ...
    init {
        ...
        evaluationTargetForm = EvaluationTargetForm2(response.evaluationItems, judgment?.evaluationItemId)
    ...
    private fun createAssignmentForm(): Component {
        return assignment?.let { AssignmentForm2(it) } ?: FormLayout()
    }

    private fun createJudgmentForm(): Component {
        return judgment?.let { JudgmentForm2(it, judgmentService) } ?: FormLayout()
    }
