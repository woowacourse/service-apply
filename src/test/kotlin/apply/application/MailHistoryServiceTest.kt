...
class MailHistoryServiceTest {
    ...
    fun `메일 이력을 저장한다`() {
        ...
        every { emailHistoryRepository.save(any()) } returns EmailHistory(
            "제목1",
            "본문입니다.",
    ...
    fun `저장된 메일 이력을 모두 조회한다`() {
        ...
        val emailHistory1 = EmailHistory("제목1", "본문입니다.", "woowacourse@woowa.com", recipients.listToString(), now)
        val emailHistory2 = EmailHistory("제목2", "본문입니다.", "woowacourse@woowa.com", recipients.listToString(), now)
