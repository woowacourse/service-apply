...
const dummyRecruitmentItems = {
  message: "",
  body: {
    title: "웹 백엔드 3기",
    startDateTime: "2021-07-27T09:01:29.168744",
    endDateTime: "2021-07-27T09:01:29.168786",
    recruitable: true,
    hidden: true,
    recruitmentItems: [
      {
...
const dummyRecruitment = {
  id: 2,
  title: "웹 백엔드 3기",
  recruitable: false,
  hidden: false,
  startDateTime: "2021-07-27T09:19:14.908768",
  endDateTime: "2021-07-27T09:19:14.908866",
  status: "ENDED",
};
...
const dummyFormData = {
  ...
  body: {
    ...
    createdDateTime: "2021-07-28T14:21:10.330439",
    modifiedDateTime: "2021-07-29T00:51:00.104171",
...
const ApplicationRegister = () => {
  ...
  const recruitment = dummyRecruitment;
  ...
  const fetchRecruitmentItems = async () => {
    try {
      ...
      // setRecruitmentItems(
      //   data.body.recruitmentItems
      // );

      setRecruitmentItems(dummyRecruitmentItems.body.recruitmentItems);
